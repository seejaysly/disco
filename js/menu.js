    ...
    gdocs.constructMoveManyBody_ = function (docs) { //pass in the docs list
        ...
        for (var i; i < docs.length; i++) {
            ...
            atom += ["<entry xmlns='http://www.w3.org/2005/Atom'>",
                "<id>https://sheets.googleapis.com/v4/spreadsheets/", docId, "/values:append?valueInputOption=RAW&responseValueRenderOption=UNFORMATTED_VALUE&insertDataOption=INSERT_ROWS&responseDateTimeRenderOption=SERIAL_NUMBER&includeValuesInResponse=true&alt=json</id>",
                "</entry>"
            ].join('');
        }
        return atom;
